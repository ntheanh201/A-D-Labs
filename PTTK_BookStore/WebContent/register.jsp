<%-- Document : register.jsp Created on : Nov 5, 2019, 9:12:39 PM Author :
os_hoangpn --%> <%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body style="background-color: azure; height: 200px">
    ...
    <h1 style="margin-left: 300px; color: red">
      Register now for your First-Super-Discount!
    </h1>
